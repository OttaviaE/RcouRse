...
header-includes:
    ...
    # - \setbeamertemplate{headline}{\begin{beamercolorbox}[ignorebg,ht=2.25ex,dp=3.75ex]{section in head/foot} \insertsectionnavigationhorizontal{\paperwidth}{}{\hfill\hfill} \end{beamercolorbox}
#          }
editor_options: 
