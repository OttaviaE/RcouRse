...
- $H_0$: $P(X_i = k) = p_k$ for all $k=1, \ldots, r (i = 1, \ldots, n)$

- $H_0$: $P(X_i = k) = p_k$ for *at least* one  $k \in 1, \ldots, r (i = 1, \ldots, n)$

Test statistic: 

$$\chi^2 = \displaystyle \sum_{i=1}^{n}\frac{(f_o - f_e)^2}{f_e}, \, \, \chi^ \sim \chi^2(r-1)$$
